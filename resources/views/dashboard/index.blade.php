                    ...
                    <div class="flex pt-4">
                        <a href="/">
                            <img class="size-11 transition-transform duration-500 ease-in-out hover:rotate-[360deg]"
                                src="{{ asset('image/favicon.png') }}" alt="logo" />
                        </a>
                    </div>
                    ...
                    <div class="flex flex-col items-center space-y-3 py-3">
                        ...
                        <div x-data="usePopper({ placement: 'right-end', offset: 12 })" @click.outside="isShowPopper && (isShowPopper = false)"
                            ...
                            <button @click="isShowPopper = !isShowPopper" x-ref="popperRef" class="avatar size-12">
                                <img class="rounded-full" src="{{ asset('image/favicon.png') }}" alt="avatar" />
                                <span
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="avatar size-14">
                                            <img class="rounded-full" src="{{ asset('image/favicon.png') }}"
                                                alt="avatar" />
                                        </div>
                                        <div>
                                            <a href="#"
                ...
                <div x-data="{ activeTab: 'tabHome' }"
                            ...
                            <div class="mt-3 grid grid-cols-2 gap-3 px-3">
                                <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                                    <div class="flex items-center space-x-2">
                                        <img class="size-10" src="images/100x100.png" alt="image" />
                                        <div>
                                ...
                                <div class="flex -space-x-3">
                                    <div class="avatar h-7 w-7 hover:z-10">
                                        <img class="rounded-full ring ring-white dark:ring-navy-700"
                                            src="{{ asset('image/favicon.png') }}" alt="avatar" />
                                    </div>
                                    <div class="avatar h-7 w-7 hover:z-10">
                                        <div
                    ...
                    <div x-show="activeTab === 'tabActivity'"
                        ...
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="size-8 text-secondary dark:text-secondary-light" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            ...
                            <li class="timeline-item">
                                ...
                                <div class="timeline-item-content flex-1 pl-4">
                                    ...
                                    <div class="avatar mt-2 size-20">
                                        <img class="mask is-squircle" src="{{ asset('image/favicon.png') }}"
                                            alt="avatar" />
                                    </div>
                                </div>
                            </li>
                        ...
                        <table class="is-hoverable w-full text-left">
                            ...
                            <tbody>
                                ...
                                <tr class="border border-transparent border-b-slate-200 dark:border-b-navy-500">
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">{{$lot->id}}</td>
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">{{$lot->kf_customer_Id}}</td>
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">{{$lot->customer_name}}</td>
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">{{$lot->lot_no}}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
