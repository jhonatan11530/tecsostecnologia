                            ...
                            <div :class="isShowPopper && 'show'" class="popper-root fixed" x-ref="popperRoot">
                                <div
                                    ...
                                    <div class="flex flex-col pt-2 pb-5">
                                        ...
                                        <div class="mt-3 px-4">
                                            <a href="{{ url('logout') }}" class="btn h-9 w-full space-x-2 bg-primary text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                    ...
                    <div class="-mr-1.5 flex items-center space-x-2">
                        ...
                        <div x-effect="if($store.global.isSearchbarActive) isShowPopper = false"
                            ...
                            <button @click="isShowPopper = !isShowPopper" x-ref="popperRef"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="size-5 text-slate-500 dark:text-navy-100" stroke="currentColor"
                                    fill="none" viewBox="0 0 24 24">
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center space-x-2">
                                                <div class="avatar h-7 w-7">
                                                    <img class="rounded-full" src="images/200x200.png"
                                                        alt="avatar" />
                                                </div>
                                                <div>
                    ...
                    <div class="grid grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-5 lg:grid-cols-2">
                        ...
                        <div class="rounded-lg bg-slate-150 p-4 dark:bg-navy-700">
                            <div class="flex justify-between space-x-1">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-5 text-secondary"
                                    fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
